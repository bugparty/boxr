...
if(NOT GTSAM_FOUND)
    EXTERNALPROJECT_ADD(GTSAM_EXT
            ...
            CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${CMAKE_BINARY_DIR}/install -DCMAKE_BUILD_TYPE=Release -DGTSAM_WITH_TBB=OFF -DGTSAM_USE_SYSTEM_EIGEN=ON -DGTSAM_POSE3_EXPMAP=ON -DGTSAM_ROT3_EXPMAP=ON -DGTSAM_BUILD_TESTS=OFF -DGTSAM_BUILD_EXAMPLES_ALWAYS=OFF -DCMAKE_INSTALL_LIBDIR=lib
            )

    # set variables for use by modules that depend on this one
    set(GTSAM_EXTERNAL Yes)      # Mark that this module is being built
    set(GTSAM_INCLUDE_DIR "${CMAKE_BINARY_DIR}/install/include")
